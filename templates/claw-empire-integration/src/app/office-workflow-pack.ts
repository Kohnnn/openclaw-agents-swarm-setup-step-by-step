...
const PACK_SEED_PROFILE: Partial<Record<WorkflowPackKey, SeedProfile>> = {
  ...
  fts: {
    nameOffset: 5,
    tone: {
      ko: "보안, 규정 준수, 그리고 빠르고 안정적인 금융 서비스 구축을 우선합니다.",
      en: "Prioritizes security, compliance, and building fast, stable financial services.",
      ja: "セキュリティ、コンプライアンス、そして迅速で安定した金融サービスの構築を優先します。",
      zh: "优先保证安全性、合规性，以及构建快速稳定的金融服务。",
    },
  },
};
...
const PACK_PRESETS: Record<WorkflowPackKey, PackPreset> = {
  ...
  fts: {
    ...
    summary: {
      ko: "보안과 규정을 준수하는 자율 개발 조직",
      en: "Security and compliance-focused autonomous dev org",
      ja: "セキュリティとコンプライアンスを重視した自律開発組織",
      zh: "注重安全与合规的自动化开发组织",
    },
    roomThemes: {
      ceoOffice: { floor1: 0x1f2937, floor2: 0x111827, wall: 0x374151, accent: 0xf59e0b },
      planning: { floor1: 0xf3f4f6, floor2: 0xe5e7eb, wall: 0x9ca3af, accent: 0x3b82f6 },
      dev: { floor1: 0xeff6ff, floor2: 0xdbeafe, wall: 0x60a5fa, accent: 0x2563eb },
      design: { floor1: 0xfdf4ff, floor2: 0xfae8ff, wall: 0xe879f9, accent: 0xc026d3 },
      qa: { floor1: 0xfef2f2, floor2: 0xfee2e2, wall: 0xf87171, accent: 0xdc2626 },
      devsecops: { floor1: 0xfefce8, floor2: 0xfef08a, wall: 0xfacc15, accent: 0xca8a04 },
      operations: { floor1: 0xf0fdf4, floor2: 0xdcfce7, wall: 0x4ade80, accent: 0x16a34a },
      breakRoom: { floor1: 0xffedd5, floor2: 0xfed7aa, wall: 0xfdba74, accent: 0xea580c },
    },
    departments: {
      planning: {
        name: { ko: "기획 및 아키텍처", en: "Planning & Architecture", ja: "企画とアーキテクチャ", zh: "规划与架构" },
        icon: "🏛️",
        agentPrefix: { ko: "아키텍트", en: "Architect", ja: "アーキテクト", zh: "架构师" },
        avatarPool: ["🏛️", "🛡️", "🏗️"],
      },
      dev: {
        name: { ko: "코어 엔지니어링", en: "Core Engineering", ja: "コア・エンジニアリング", zh: "核心工程" },
        icon: "⚡",
        agentPrefix: { ko: "엔지니어", en: "Engineer", ja: "エンジニア", zh: "工程师" },
        avatarPool: ["⚡", "⚙️", "💻"],
      },
      qa: {
        name: { ko: "품질 및 컴플라이언스", en: "Quality & Compliance", ja: "品質とコンプライアンス", zh: "质量与合规" },
        icon: "⚖️",
        agentPrefix: { ko: "오디터", en: "Auditor", ja: "オーディター", zh: "审计员" },
        avatarPool: ["⚖️", "🔍", "✅"],
      },
    },
    staff: {
      nonLeaderDeptCycle: ["dev", "dev", "qa", "qa", "planning", "dev", "qa", "dev"],
    },
  },
};
